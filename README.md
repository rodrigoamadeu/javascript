...
### Exemplos
Seleciona o objeto e diposinibiliza (métodos / funções) .createElement esse é o .callback

- document.getElementById(id) 
- document.getElementsByTagName('div')
- document.createElement('div')
- parentNode.appendChild(node) // html.appendChild('body') dentro do html esse código inseri o body.
- element.innerHTML 
- element.style
- element.setAttribute('name') // o set é o setar, define, inseri o atributo
- element.getAttribute('name') // o get é o trazer, buscar, pegar o atributo
